                ...
                <div className="space-y-8 text-gray-700">
                    <section>
                        ...
                        <p>
                            ...
                            규정함을 목적으로 합니다. 개인정보 처리에 관해서는 '개인정보 처리방침'에 따릅니다.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mt-4">
                            <strong>[금융 상담 서비스 관련 고지]</strong><br />
                            사이트가 제공하는 AI 금융 상담 결과는 일반적인 금융 정보를 바탕으로 한 참고용 자료입니다.
                            개인의 신용 상태나 금융사의 정책 변경에 따라 실제 결과는 달라질 수 있습니다.
                            따라서 본 서비스의 결과는 법적 효력을 갖지 않으며, 대출 실행이나 투자를 위한 최종 판단의 근거가 될 수 없습니다.
                            실제 금융 거래 시에는 반드시 해당 금융기관이나 전문가와 상담하시기 바랍니다.
                        </p>
                    </section>
