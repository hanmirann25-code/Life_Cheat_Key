...
export default function JoseonResultCard({ result, onReset }: JoseonResultCardProps) {
    ...
    const handleDownloadAndShare = async () => {
        ...
        try {
            ...
            // Create File object
            const file = new File([blob], `joseon-face-${Date.now()}.png`, { type: 'image/png' });
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="group flex items-center gap-3 bg-gradient-to-r from-red-800 to-amber-700 text-amber-50 px-10 py-5 rounded-full font-black text-xl hover:scale-105 transition-all duration-200 shadow-lg"
                    style={{ boxShadow: '0 6px 16px rgba(153, 27, 27, 0.5)', fontFamily: "'Noto Serif KR', serif" }}
                >
                ...
                <div className="flex flex-wrap gap-3 justify-center items-center">
                    <button
                        ...
                        className="group flex items-center gap-2 text-amber-900 hover:text-amber-700 px-4 py-2 rounded-full font-semibold text-sm transition-all duration-200"
                        style={{ fontFamily: "'Noto Serif KR', serif" }}
                    >
                    ...
                    <button
                        onClick={onReset}
                        className="text-amber-900 hover:text-amber-700 font-semibold px-4 py-2 rounded-full transition-colors duration-200"
                        style={{ fontFamily: "'Noto Serif KR', serif" }}
                    >
                        다시 분석하기
                    </button>
